...
{
    class GUI_Boost_Tow_But : GUI_Button
    {
        private Main_State mainState;
        static int X = 125 - ((Resources.Tow_Basic.Width - Level.TileWidth) / 2);
        static int Y = 625 - ((Resources.Tow_Basic.Height - Level.TileWidth) / 2);

        public GUI_Boost_Tow_But(Main_State mainState)
            : base(Resources.Tow_Boost, Resources.Tow_Boost, X, Y)
        {
        ...
        public override void Press(System.Windows.Forms.MouseEventArgs e)
        {
            ...
            mainState.TowerToAdd = new Tow_Boost(mainState.towers);
        }
